/*! @longteng/vue-grid-layout - 5.0.7 | (c) 2015, 2022  Gustavo Santos (JBay Solutions) <gustavo.santos@jbaysolutions.com> (http://www.jbaysolutions.com) | https://github.com/jbaysolutions/vue-grid-layout */
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"e44d2152-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/GridItem.vue?vue&type=template&id=6dc62893&
...
// CONCATENATED MODULE: ./src/components/GridItem.vue?vue&type=template&id=6dc62893&
...
/* harmony default export */ var GridItemvue_type_script_lang_js_ = ({
  ...
  methods: {
    scaleCoordinate: function scaleCoordinate(coordinate) {
        ...
        case "resizemove":
          {
            ...
            newSize.height = this.resizing.height + this.scaleCoordinate(coreEvent.deltaY); ///console.log("### resize => " + event.type + ", deltaX=" + coreEvent.deltaX + ", deltaY=" + coreEvent.deltaY);
        ...
        case "dragend":
          {
            ...
            if (this.renderRtl) {
              newPosition.left = (this.scaleCoordinate(_clientRect.right) - this.scaleCoordinate(_parentRect.right)) * -1;
            } else {
              newPosition.left = this.scaleCoordinate(_clientRect.left) - this.scaleCoordinate(_parentRect.left);
            }

            newPosition.top = this.scaleCoordinate(_clientRect.top) - this.scaleCoordinate(_parentRect.top); //                        console.log("### drag end => " + JSON.stringify(newPosition));
        ...
        case "dragmove":
          {
            ...
            newPosition.top = this.dragging.top + this.scaleCoordinate(coreEvent.deltaY); //                        console.log("### drag => " + event.type + ", x=" + x + ", y=" + y);
